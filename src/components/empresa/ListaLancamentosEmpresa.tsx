...
export function ListaLancamentosEmpresa() {
  const { receitas, despesas, removerReceita, removerDespesa } = useEmpresaStore();
  ...
  if (todos.length === 0) {
    return (
      <EmptyState 
        ...
        title="Nenhum lançamento empresarial" 
        description="Receitas e despesas da empresa aparecerão aqui." 
      />
    );
  }
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 text-xs text-neutral-500">
                  ...
                  <span>•</span>
                  <span className="uppercase">{item.categoria}</span>
                </div>
              </div>
            </div>
